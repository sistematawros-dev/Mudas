function t(l={}){const{label:d="Label",color:s="neutral",size:r="md",showDot:n=!0,outlined:i=!1,dark:u=!1,className:o=""}=l,a=["status-badge",`status-badge--${s}`];r!=="md"&&a.push(`status-badge--${r}`),i&&a.push("status-badge--outlined"),u&&a.push("status-badge--dark"),o&&a.push(o);const m=n?'<span class="status-dot"></span>':"";return`
    <span class="${a.join(" ")}">
      ${m}
      <span>${d}</span>
    </span>
