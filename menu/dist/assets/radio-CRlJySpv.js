/* empty css              */function g(t={}){const{id:a=`radio-${Date.now()}`,name:o="radio-group",value:r="",label:d="",description:l="",checked:n=!1,disabled:i=!1,error:c=!1,size:u="md",dark:s=!1,className:b=""}=t,m=["radio"];u!=="md"&&m.push(`radio--${u}`),i&&m.push("radio--disabled"),c&&m.push("radio--error"),s&&m.push("radio--dark"),b&&m.push(b);const p=d||l?`
