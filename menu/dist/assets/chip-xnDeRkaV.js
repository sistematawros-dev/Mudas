import{b as e}from"./chip-1Or3KqV6.js";function t(){document.getElementById("chip-multiple").innerHTML=`
  ...
  `,e.init(document,l=>{console.log("Chip event:",l)})}export{t as init};
