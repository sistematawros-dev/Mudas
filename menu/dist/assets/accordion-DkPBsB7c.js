function a(o=document){o.querySelectorAll("[data-accordion]").forEach(r)}function r(o){const i=o.dataset.accordion||"single";o.querySelectorAll(".accordion-header").forEach(t=>{t.addEventListener("click",()=>{const c=t.closest(".accordion-item"),e=c.classList.contains("is-open");i==="single"&&!e&&o.querySelectorAll(".accordion-item.is-open").forEach(n=>{n.classList.remove("is-open")}),c.classList.toggle("is-open")})})}function d(o,i={}){const{variant:s="",mode:t="single"}=i,c=["accordion"];return s&&c.push(`accordion--${s}`),`
  ...
  `}const l={init:a,create:d};function p(){l.init()}export{p as init};
