function u(e={}){const{id:t=`toggle-${Date.now()}`,name:n="",label:s="",labelPosition:i="right",checked:l=!1,disabled:a=!1,color:o="primary",size:g="md",loading:d=!1,dark:r=!1,className:p=""}=e,c=["toggle"];g!=="md"&&c.push(`toggle--${g}`),o!=="primary"&&c.push(`toggle--${o}`),a&&c.push("toggle--disabled"),d&&c.push("toggle--loading"),r&&c.push("toggle--dark"),p&&c.push(p);const f=s?`
