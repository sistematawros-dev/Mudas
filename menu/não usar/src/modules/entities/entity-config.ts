...
export const ENTITY_CONFIGS: EntityConfig[] = [
  ...
  },
  {
    ...
    idField: 'id',
    defaultSort: 'nome',
    searchableFields: ['codigo', 'nome', 'cnpj'],
    filterableFields: ['id', 'codigo', 'nome', 'cnpj', 'ativo', 'external_source', 'external_id', 'created_at', 'updated_at', 'deleted_at'],
    creatableFields: ['codigo', 'nome', 'cnpj', 'ativo', 'external_source', 'external_id'],
    updatableFields: ['codigo', 'nome', 'cnpj', 'ativo', 'external_source', 'external_id'],
    hasSoftDelete: true,
    hasExternal: true,
    auditEnabled: true
  },
  {
    resource: 'licencas-modulos',
    schema: 'app',
    table: 'licencas_modulos',
    idField: 'id',
    defaultSort: 'modulo',
    searchableFields: ['modulo'],
    filterableFields: ['id', 'modulo', 'quantidade_licencas', 'ativo', 'external_source', 'external_id', 'created_at', 'updated_at', 'deleted_at'],
    creatableFields: ['modulo', 'quantidade_licencas', 'ativo', 'external_source', 'external_id'],
    updatableFields: ['modulo', 'quantidade_licencas', 'ativo', 'external_source', 'external_id'],
    hasSoftDelete: true,
    hasExternal: true,
    auditEnabled: true
  },
  {
    ...
    filterableFields: [
      ...
      'quantidade_total', 'patio_fase', 'chegada_em', 'chamado_em', 'entrada_em', 'finalizado_em', 'ordem_fila',
      'ativo', 'external_source', 'external_id', 'created_at', 'updated_at', 'deleted_at'
    ],
    creatableFields: [
      ...
      'data_agendamento', 'nome_motorista', 'placa_veiculo',
      'quantidade_total', 'patio_fase', 'chegada_em', 'chamado_em', 'entrada_em', 'finalizado_em', 'ordem_fila',
      'ativo', 'external_source', 'external_id'
    ],
    updatableFields: [
      'numero_instrucao', 'data_emissao', 'prazo_final_carregamento', 'comprador_id', 'numero_contrato',
      'produtor_documento', 'produtor_id', 'nome_vendedor_produtor', 'tipo_produto', 'filial_id', 'status',
  ...
  {
    resource: 'agenda-disponibilidade',
    schema: 'app',
    table: 'agenda_disponibilidade',
    idField: 'id',
    defaultSort: 'data_carregamento',
    searchableFields: ['tipo_produto', 'status'],
    filterableFields: [
      'id', 'filial_id', 'data_carregamento', 'tipo_produto', 'status', 'mensagem_bloqueio',
      'vagas_total', 'vagas_ocupadas', 'limite_transportadora', 'ativo', 'external_source', 'external_id',
      'created_at', 'updated_at', 'deleted_at'
    ],
    creatableFields: [
      'filial_id', 'data_carregamento', 'tipo_produto', 'status', 'mensagem_bloqueio',
      'vagas_total', 'vagas_ocupadas', 'limite_transportadora', 'ativo', 'external_source', 'external_id'
    ],
    updatableFields: [
      'filial_id', 'data_carregamento', 'tipo_produto', 'status', 'mensagem_bloqueio',
  ...
  },
  {
    ...
    idField: 'id',
    defaultSort: 'created_at',
    searchableFields: ['descricao', 'placa', 'marca', 'modelo'],
    filterableFields: [
      'id', 'grupo', 'descricao', 'placa', 'marca', 'modelo', 'carga_maxima_kg', 'vinculo_tipo', 'ativo',
      'external_source', 'external_id', 'created_at', 'updated_at', 'deleted_at'
    ],
    creatableFields: [
      'grupo', 'descricao', 'placa', 'marca', 'modelo', 'carga_maxima_kg', 'vinculo_tipo', 'ativo',
    ...
    relations: [
      { name: 'documentos', table: 'veiculos_documentos', sourceKey: 'id', targetKey: 'veiculo_id' },
      { name: 'vinculos', table: 'veiculos_vinculos', sourceKey: 'id', targetKey: 'veiculo_id' }
    ],
    hasSoftDelete: true,
    hasExternal: true,
    auditEnabled: true
  ...
  {
    resource: 'veiculos-documentos',
    schema: 'app',
    table: 'veiculos_documentos',
    idField: 'id',
    defaultSort: 'ordem',
    searchableFields: ['nome_arquivo'],
    filterableFields: [
      'id', 'veiculo_id', 'nome_arquivo', 'tamanho_bytes', 'ordem',
      'external_source', 'external_id', 'created_at', 'updated_at', 'deleted_at'
    ],
    creatableFields: ['veiculo_id', 'nome_arquivo', 'tamanho_bytes', 'ordem', 'external_source', 'external_id'],
    updatableFields: ['veiculo_id', 'nome_arquivo', 'tamanho_bytes', 'ordem', 'external_source', 'external_id'],
    hasSoftDelete: true,
    hasExternal: true,
    auditEnabled: false
  },
  {
    resource: 'veiculos-vinculos',
    schema: 'app',
    table: 'veiculos_vinculos',
    idField: 'id',
    defaultSort: 'id',
    searchableFields: [],
    filterableFields: [
      'id', 'veiculo_id', 'pessoa_empresa_id',
      'external_source', 'external_id', 'created_at', 'updated_at', 'deleted_at'
    ],
    creatableFields: ['veiculo_id', 'pessoa_empresa_id', 'external_source', 'external_id'],
    updatableFields: ['veiculo_id', 'pessoa_empresa_id', 'external_source', 'external_id'],
    hasSoftDelete: true,
    hasExternal: true,
    auditEnabled: false
  },
...
export function getEntityConfig(resource: string): EntityConfig | undefined {
  ...
  const byExact = ENTITY_CONFIGS.find((e) => e.resource === raw);
  if (byExact) return byExact;

  const normalized = normalizeResourceName(raw);
  return ENTITY_CONFIGS.find((e) => normalizeResourceName(e.resource) === normalized);
}
