...
const closeDrawerClasse = document.getElementById('closeDrawerClasse');
...
// Close drawer
if (closeDrawerClasse) {
    closeDrawerClasse.addEventListener('click', () => {
...
console.log('Cadastro de Produto scripts loaded');
